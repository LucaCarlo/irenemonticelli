...
const SCHEMA = {
  general: {
    ...
    fields: [
      ...
      { key: 'bookings_enabled', label: 'Prenotazioni online attive', type: 'bool', def: '0',
        help: 'Quando OFF, gli utenti possono compilare il checkout ma al click su "Confirmar y pagar" vedono un avviso che le prenotazioni sono temporaneamente disabilitate (con link alla pagina contatti).' },
  ...
  legal: {
    label: 'Footer + Legali',
    fields: [
      { key: 'footer_credit_html', label: 'Footer — credit line (HTML)', type: 'textarea',
        def: '© 2026 Irene Monticelli — NIF ESY3881467R',
        help: 'HTML del credito footer. Compare nella riga in basso a sinistra del footer. Puoi usare <a>, <strong>, <em>.' },
      { key: 'legal_company', label: 'Nome titolare del trattamento', type: 'text', def: 'Irene Monticelli',
        help: 'Usato nelle pagine Privacy e Cookies' },
      { key: 'legal_email', label: 'Email titolare', type: 'text', def: 'info@irenemonticelli.com' },
      { key: 'legal_address', label: 'Indirizzo / sede', type: 'text', def: 'Santa Pola, Alicante, España' },
      { key: 'legal_authority', label: 'Autorità di controllo (paese)', type: 'text', def: 'Agencia Española de Protección de Datos (AEPD)' },
      { key: 'refund_days', label: 'Giorni rimborso (dopo prenotazione)', type: 'number', def: '15',
        help: 'Numero di giorni dalla data di prenotazione entro cui è possibile chiedere il rimborso. Mostrato nel checkout sotto il pulsante "Confirmar y pagar".' },
    ],
  },
  social: {
    label: 'Social media',
